                    ...
                    {navItems.map((item) => {
                        ...
                        return (
                            <li key={item.href}>
                                <Link
                                    href={item.href}
                                    className={`flex items-center p-3 rounded-xl font-medium transition-colors ${isActive
                                            ? 'bg-[#4EFF9B]/20 text-[#4EFF9B]'
                                            : 'text-[#A0C4B5] hover:bg-[#15362B] hover:text-[#E9F5EE]'
                                        }`}
                                >
                                    {item.icon}
                                    {item.name}
